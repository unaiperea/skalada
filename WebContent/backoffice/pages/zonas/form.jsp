            ...
            <div class="row">
				...
				<form role="form" action="<%=Constantes.CONTROLLER_ZONAS%>" method="post">
					...
					<div class="form-group">
                    	...
                    	<input type="hidden" name="id" value="<%=z.getId()%>"> <!-- Si viaja en el formulario -->
            			<input type="text" class="form-control" value="<%=z.getId()%>" disabled> <!-- No viaja en el formulario -->
            		</div>	
				
					<div class="form-group">
                    	<label for="nombre">Nombre</label>
                        <input class="form-control" name="nombre" type="text" value="<%=z.getNombre()%>">                        
                    </div>
								...
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
											<h2 class="modal-title text-center text-danger"><i class="fa fa-exclamation-triangle"></i> ELIMINAR: <%=z.getNombre().toUpperCase() %></h2>
						  			</div>
						  			...
						  			<div class="modal-footer">						    			
						    			<a href="<%=Constantes.CONTROLLER_ZONAS%>?accion=<%=Constantes.ACCION_ELIMINAR%>&id=<%=z.getId()%>" id ="boton_eliminar" class="btn btn-danger btn-xs disabled">Eliminar</a>
