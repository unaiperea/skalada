...
/**
 * Clase de constantes usados en todo el proyecto
 * 
 * @author Curso
 *
 */
public final class Constantes {
	 ...
	 */
	private Constantes() { // CeckStyle te obliga a crear el constructor
							// (private) para que no cree uno por defecto al
							// compilar
		super();
	}
